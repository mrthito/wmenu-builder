...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('MrThito\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('MrThito\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}

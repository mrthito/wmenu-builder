...
<script type="text/javascript" src="{{asset('vendor/mrthito-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mrthito-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mrthito-menu/menu.js')}}"></script>
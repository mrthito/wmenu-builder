...
[![Latest Stable Version](https://poser.pugx.org/mrthito/laravel-menu/v/stable)](https://packagist.org/packages/mrthito/laravel-menu) [![Latest Unstable Version](https://poser.pugx.org/mrthito/laravel-menu/v/unstable)](https://packagist.org/packages/mrthito/laravel-menu) [![Total Downloads](https://poser.pugx.org/mrthito/laravel-menu/downloads)](https://packagist.org/packages/mrthito/laravel-menu) [![Monthly Downloads](https://poser.pugx.org/mrthito/laravel-menu/d/monthly)](https://packagist.org/packages/mrthito/laravel-menu)

forked from https://github.com/lordmacu/wmenu
![Laravel drag and drop menu](https://raw.githubusercontent.com/mrthito/wmenu-builder/master/screenshot.png)
...
```php
composer require mrthito/laravel-menu
```
...
```php
MrThito\Menu\MenuServiceProvider::class,
```

3. add facade in the file config/app.php (optional on laravel 5.5)

```php
'Menu' => MrThito\Menu\Facades\Menu::class,
```

4. Run publish

```php
php artisan vendor:publish --provider="MrThito\Menu\MenuServiceProvider"
```
...
### KNOWN ISSUES
- Not working with RTL websites [#21](https://github.com/mrthito/wmenu-builder/issues/21) (pull requests are welcome)
